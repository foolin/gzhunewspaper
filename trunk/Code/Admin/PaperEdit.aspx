<%@ Page Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="PaperEdit.aspx.cs" Inherits="Admin_PaperEdit" Title="Untitled Page" %>
...
<div class="list">
    <table>
        <tr>
            <th colspan="2">修改校报信息</th>
        </tr>
        <tr>
            <td>期数：</td>
            <td> 
                <asp:TextBox ID="txtPaperID" ReadOnly="true" runat="server"></asp:TextBox> <span style="color:#666">(不能修改期刊数字)</span></td>
        </tr>
        <tr>
            <td>出版日期：</td>
            <td>
