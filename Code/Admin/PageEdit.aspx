<%@ Page Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="PageEdit.aspx.cs" Inherits="Admin_PageEdit" Title="Untitled Page" %>
...
<div class="list">
    <table>
        <tr>
            <th colspan="2">修改版面信息</th>
        </tr>
        <tr>
            <td>期数：</td>
            <td> 
                第<asp:DropDownList ID="txtPaperID" runat="server" Enabled="False"></asp:DropDownList>期</td>
        </tr>
        <tr>
            <td>版面：</td>
            <td>
                <asp:TextBox ID="txtPageID" style="color:Gray" runat="server" Enabled="False"></asp:TextBox> 
            </td>
        </tr>
        <tr>
            <td>版面名称</td>
